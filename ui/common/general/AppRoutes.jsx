...
const AppContent = () => {
  return (
    ...
    />
        ...
        <Route path="album/:albumId" element={<PublicLayout><AlbumDetail /></PublicLayout>} />
        <Route path="/album" element={<PublicLayout><Album /></PublicLayout>} />
   ...
   <Route path={`${RoutePaths.PROFILE_PAGE}/:userId`}
  element={
    <LoggedUserOnly>
      <PublicLayout>
        <ProfilePage />
