...
const engagement = [
  ...
  { name: 'Singles', href: '/singles', icon: UsersIcon },
        ...
        <div className="flex justify-between items-center mx-auto max-w-7xl px-6 lg:px-8">
          ...
          <div className="flex-grow flex items-center justify-center space-x-2">
            ...
            <Popover.Button
              ...
              focus-visible:outline-offset-2 transition duration-300 ease-in-out bg-gradient-to-r from-teal-500
  via-emerald-500 to-lime-600 hover:shadow-lg hover:opacity-75 hover:scale-105 hover:bg-gradient-to-r hover:from-teal-400 hover:via-emerald-400 hover:to-lime-500 text-white"
            >
              Discover
