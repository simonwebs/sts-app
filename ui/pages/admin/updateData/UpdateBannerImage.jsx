...
const UpdateBannerImage = () => {
  ...
  return (
    <div className="relative">
      <button onClick={() => setOpen(true)} className="p-1 bg-transparent rounded-full shadow-lg">
        <MdAddAPhoto className="w-6 h-6   text-gray-400 hover:text-gray-400/7  hover:shadow-md" />
      </button>
  ...
  // Remove the aspectRatio prop to allow freeform cropping
  preview=".img-preview"
  guides={false}
  ref={cropperRef}
  viewMode={1}
