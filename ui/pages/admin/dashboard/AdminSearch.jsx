...
const AdminSearch = () => {
  ...
  return (
     <div className="user-search-container relative">
      <button
        className="flex items-center px-4 py-2 rounded-full bg-transparent dark:bg-cyan-800/100 text-gray-200 dark:text-white hover:bg-opacity-75 transition duration-300 ml-5"
        onClick={() => setSearchOpen(!searchOpen)}
      >
        <MagnifyingGlassIcon className="h-5 w-5 mr-2 stroke-2 text-gray-100 dark:text-gray-100" />
      ...
      <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 bg-white dark:bg-cyan-800 rounded-lg shadow-xl w-3/4 max-w-xl">
            <div className="p-6">
              <div className="relative">
                <input
                  ...
                  className="w-full py-2 px-4 shadow-sm rounded-xl bg-gray-100 dark:bg-cyan-800 border border-gray-300 dark:border-gray-700 focus:border-indigo-500 dark:focus:border-indigo-300 focus:ring focus:ring-indigo-200 dark:focus:ring-indigo-700 focus:ring-opacity-50 dark:text-white dark:placeholder-cyan-400 pl-10"
                  value={searchQuery}
